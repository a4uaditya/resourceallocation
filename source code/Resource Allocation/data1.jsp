...
<br>
      ...
      <div class="column_w430 fl vl_divider"> 
	    <h3><font color="#FFFF00" size="5">ResourceAllocation In CloudDatabase</font></h3>
       <h3><font color="#FFFFFF" size="3">Virtualization In GreenComputing </font></h3>
        <br><br>
       
            <table><td width="200"></td><td><img src="images/logotype.jpg"></td></table>
