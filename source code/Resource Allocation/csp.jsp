...
<div id="templatemo_container">
	...
	<div id="templatemo_content_wrapper">
    	...
    	<div class="column_w210 fl">
        	...
        	<div class="header_01">
			<br><br><br>
           <img src="images/cloud ser provider.jpg" width="190" height="250">
            </div>
        ...
        <p><font color="#FFFFFF" size="3"> The next generation Cloud Servers powered 
          by OpenStack is a fast, reliable, and scalable cloud compute solution.A 
          more responsive API makes automating common tasks easier. Also available 
          with a managed service level. Scalable websites, SaaS applications, 
          Databases for web apps</font></p>
            
         
      
        
    <p><font color="#FFFF00" size="3"><strong>Create a free Cloud account and explore what 
      you can build!</strong></font></p>
		<h5 align="right"> <a href="cspacc.jsp"><img src="images/sign.png"></a></h5>
