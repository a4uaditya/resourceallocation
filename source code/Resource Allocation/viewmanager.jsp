...
try{
   ...
   String s = "select * from ownerreg where utype='Manager'";
...
adoption of virtualization<br /><strong></strong></p>
        ...
        <p><strong><font color="#000000">View Manager Details:</font></strong></p>
        <table align="center" width="640" style="border:10px solid #335B63;">
          <tr bgcolor="#335B63"> 
            <th width="150" height="47"><font color="#FFFFFF">Name</font></th>
            <th width="150"><font color="#FFFFFF">Email</font></th>
            <th width="150"><font color="#FFFFFF">Phone</font></th>
            <th width="150"><font color="#FFFFFF">Request</font></th>
          </tr>
          <%
			while(rs.next()){
  			%>
          <tr> 
            ...
            <td><a href="request.jsp?id=<%=rs.getString("id")+","+rs.getString("name")+","+rs.getString("email")%>">Send 
              Request</a></td>
          </tr>
          <%}%>
        </table>
