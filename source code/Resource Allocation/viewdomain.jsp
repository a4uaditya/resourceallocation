...
<div id="templatemo_container">
	...
	<div id="templatemo_content_wrapper">
        ...
        <div class="column_w430 fl vl_divider">
          ...
          <%=email%></font> </p>
        <p><font color="yellow" size="3"><strong>View Domain Detail:</strong></font></p>
        <table align="center" width="691" style="border:1px solid #000000;">
          ...
          <tr> 
            <td height="49" bordercolor="#6699FF"> 
              <font color="#ffffff" size="3"><%=rs.getString("siteowner")%></font>
            </td>
            <td> 
             <font color="#ffffff" size="3"> <%=rs.getString("domainname")%></font>
             </td>
            <td> 
              <font color="#ffffff" size="3"><%=rs.getString("plan")%> days </font>
            </td>
            <td> 
             <font color="#ffffff" size="3"> <%=rs.getString("memory")%></font>MB 
            </td>
			 <td> 
             <font color="#ffffff" size="3"> <%=rs.getString("companyname")%></font>
            </td>
			 <td> 
